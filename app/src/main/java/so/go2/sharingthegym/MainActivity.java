...
public class MainActivity extends CheckPermissionsActivity
    ...
    private void AddMarker() {
        ...
        markerOption.position(new LatLng(30.761575, 103.989586)).title(getResources().getString(R.string.mapTips));
        amap.addMarker(markerOption);
        markerOption.position(new LatLng(30.771575, 103.965986)).title(getResources().getString(R.string.mapTips));
        amap.addMarker(markerOption);
        markerOption.position(new LatLng(30.781575, 103.974586)).title(getResources().getString(R.string.mapTips));
        amap.addMarker(markerOption);
        markerOption.position(new LatLng(30.765575, 103.985586)).title(getResources().getString(R.string.mapTips));
        amap.addMarker(markerOption);
        markerOption.position(new LatLng(30.761075, 103.945586)).title(getResources().getString(R.string.mapTips));
        amap.addMarker(markerOption);
        markerOption.position(new LatLng(30.763575, 103.983586)).title(getResources().getString(R.string.mapTips));
        amap.addMarker(markerOption);
        markerOption.position(new LatLng(30.766575, 103.985586)).title(getResources().getString(R.string.mapTips));
        amap.addMarker(markerOption);
